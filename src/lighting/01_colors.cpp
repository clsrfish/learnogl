...
namespace lighting
{
    namespace colors
    {
        ...
        int main()
        {
            ...
            Shader *cubeShader = new Shader("shaders/lighting/01/cube.vs", "shaders/lighting/01/cube.fs");
            Shader *lightShader = new Shader("shaders/lighting/01/light.vs", "shaders/lighting/01/light.fs");
